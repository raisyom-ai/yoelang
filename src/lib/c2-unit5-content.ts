...
export const C2_L21: LessonContent = {
  vocab: [
    {
      english: 'Motif',
      french: 'Motif / Thème récurrent',
      phonetic: '/moʊˈtiːf/',
      example: 'The motif of exile recurs throughout the postcolonial novel, structuring its entire narrative arc.',
      exampleTranslation: 'Le motif de l\'exil revient tout au long du roman postcolonial, structurant tout son arc narratif.',
    },
    {
      english: 'Polyphony',
      french: 'Polyphonie',
  ...
  pronunciation: [
    {
      ...
      phonetic: '/ˌkrɒsˈrɛfərəns/',
      meaning: 'Renvoi',
      tip: 'Accent sur "REF" : "kros-REF-er-ens". Le "cross" se prononce comme dans "across". L\'accent principal est sur la deuxième partie du mot composé.',
    },
    {
      word: 'Zeitgeist',
      phonetic: '/ˈzaɪtɡaɪst/',
...
export const C2_L22: LessonContent = {
  vocab: [
    {
      ...
      french: 'Pastiche',
      phonetic: '/pæˈstiːʃ/',
      example: 'The city is a pastiche of architectures, each era pastiched upon the remnants of the last.',
      exampleTranslation: 'La ville est un pastiche d\'architectures, chaque époque pastichée sur les vestiges de la précédente.',
    },
    {
      english: 'Semiosis',
      french: 'Sémiose',
      phonetic: '/ˌsiːmiˈoʊsɪs/',
      example: 'Gadamer\'s account of semiosis insists that meaning is always historically situated.',
      exampleTranslation: 'Le compte rendu de Gadamer de la sémiose affirme que le sens est toujours historiquement situé.',
    },
    {
      english: 'Ambiguity',
      french: 'Ambiguïté',
      phonetic: '/ˌæmbɪˈɡjuːɪti/',
      example: 'The text arrives at an ambiguity that no amount of exegetical ingenuity can resolve.',
      exampleTranslation: 'Le texte parvient à une ambiguïté qu\'aucune ingéniosité exégétique ne peut résoudre.',
    },
    {
      english: 'Mimesis',
      french: 'Mimèsis',
    ...
    {
      english: 'Allusion',
      french: 'Allusion littéraire',
      phonetic: '/əˈluːʒən/',
      example: 'The allusion to Genesis operates on both a narrative and a theological register, enriching the text beyond its surface meaning.',
      exampleTranslation: 'L\'allusion à la Genèse opère sur un registre à la fois narratif et théologique, enrichissant le texte au-delà de son sens littéral.',
    },
  ],
  grammar: {
    ...
    examples: [
      { sentence: 'Some embraced the semiotic approach; others, the empirical.', translation: 'Certains ont adopté l\'approche sémiotique ; d\'autres, l\'empirique.', isCorrect: true },
      { sentence: 'She could have contested the ambiguity, but chose not to.', translation: 'Elle aurait pu contester l\'ambiguïté, mais a choisi de ne pas le faire.', isCorrect: true },
      { sentence: 'Some embraced the semiotic approach; others embraced the empirical approach.', translation: '', isCorrect: false },
      { sentence: 'For that matter, the pastiche model applies equally to legal interpretation.', translation: 'D\'ailleurs, le modèle du pastiche s\'applique également à l\'interprétation juridique.', isCorrect: true },
    ],
    commonMistakes: [
      { wrong: 'Some embraced the semiotic approach; others embraced the empirical approach.', correct: 'Some embraced the semiotic approach; others, the empirical.', explanation: 'La répétition intégrale du verbe et du nom crée une lourdeur stylistique. L\'ellipse est de rigueur en registre soutenu : on omet le verbe déjà exprimé et on ne conserve que l\'élément contrastif.' },
  ...
  conversation: [
    { speaker: 'Nathalie', role: 'A', text: 'The pastiche metaphor is compelling, but doesn\'t it risk flattening genuine historical rupture?', translation: 'La métaphore du pastiche est séduisante, mais ne risque-t-elle pas d\'aplatir la véritable rupture historique ?', },
    { speaker: 'James', role: 'B', text: 'That\'s a fair objection. Then again, the semiotic tradition would counter that rupture itself is always already inscribed within continuity.', translation: 'C\'est une objection juste. Ceci dit, la tradition sémiotique riposterait que la rupture elle-même est toujours déjà inscrite dans la continuité.', },
    { speaker: 'Nathalie', role: 'A', text: 'To the extent that one accepts Gadamer\'s fusion of horizons, perhaps. But Derrida\'s ambiguity suggests the opposite — that some tensions are constitutively unresolvable.', translation: 'Dans la mesure où l\'on accepte la fusion des horizons de Gadamer, peut-être. Mais l\'ambiguïté de Derrida suggère le contraire — que certaines tensions sont constitutivement insolubles.', },
    { speaker: 'James', role: 'B', text: 'For that matter, Auerbach\'s mimesis argument sidesteps the issue entirely by foregrounding the imitation as the real site of negotiation.', translation: 'D\'ailleurs, l\'argument de la mimèsis d\'Auerbach contourne entièrement le problème en mettant au premier plan l\'imitation comme véritable lieu de négociation.', },
    { speaker: 'Nathalie', role: 'A', text: 'True — though one could argue that allusion and pastiche are themselves interlocked in ways neither Auerbach nor Plato fully anticipated.', translation: 'Vrai — bien qu\'on puisse soutenir que allusion et pastiche sont eux-mêmes imbriqués de façons qu\'Auerbach ni Platon n\'ont pleinement anticipées.', },
    { speaker: 'James', role: 'B', text: 'That said, the distinction remains semiotically indispensable. Without it, we lose the very vocabulary needed to describe how representation operates.', translation: 'Cela dit, la distinction reste sémiotiquement indispensable. Sans elle, nous perdons le vocabulaire même nécessaire pour décrire le fonctionnement de la représentation.', },
  ...
  conversationTitle: 'Pastiche et sémiose',
  pronunciation: [
    {
      word: 'Pastiche',
      phonetic: '/pæˈstiːʃ/',
      meaning: 'Pastiche',
      tip: 'Accent sur "STEE" : "pa-STEE-sh". Le "a" initial est ouvert comme dans "cat". Le "ch" final est doux comme dans "machine". Ne dites pas "pas-TEESH" à la française.',
    },
    {
      word: 'Semiosis',
      phonetic: '/ˌsiːmiˈoʊsɪs/',
      meaning: 'Sémiose',
      tip: 'Accent sur "OH" : "see-mee-OH-sis". Le "e" initial est long comme dans "see". Le "o" accentué est long. Le suffixe "-sis" se prononce comme dans "genesis".',
    },
    {
      word: 'Ambiguity',
      phonetic: '/ˌæmbɪˈɡjuːɪti/',
    ...
    },
    {
      word: 'Allusion',
      phonetic: '/əˈluːʒən/',
      meaning: 'Allusion littéraire',
      tip: 'Accent sur "LOO" : "uh-LOO-zhun". Le "a" initial est réduit en schwa. Le "s" = "zh" comme dans "measure". Le "-ion" final = "zhun". Ne dites pas "a-loo-ZHON" à la française.',
    },
  ],
}
...
export const C2_L24: LessonContent = {
  vocab: [
    ...
    },
    {
      ...
      example: 'An iconography of gesture reveals that even body language is culturally encoded, not universal.',
      exampleTranslation: 'Une iconographie du geste révèle que même le langage corporel est culturellement codé, non universel.',
    },
    {
      english: 'Sociolinguistics',
      french: 'Sociolinguistique',
      phonetic: '/ˌsoʊsioʊlɪŋˈɡwɪstɪks/',
      example: 'Cross-cultural sociolinguistics examines how speech acts — apologising, requesting, refusing — vary across linguistic communities.',
      exampleTranslation: 'La sociolinguistique interculturelle examine comment les actes de langage — s\'excuser, demander, refuser — varient selon les communautés linguistiques.',
    },
    {
      english: 'Idioculture',
      french: 'Idioculture',
  ...
  conversation: [
    ...
    { speaker: 'Kofi', role: 'A', text: 'And the iconography of silence differs wildly. In Japanese English interactions, silence signals respect; in American contexts, it signals discomfort or disengagement.', translation: 'Et l\'iconographie du silence diffère considérablement. Dans les interactions en anglais japonais, le silence signale le respect ; dans les contextes américains, il signale l\'inconfort ou le désengagement.', },
  ...
  pronunciation: [
    ...
    },
    {
      ...
      tip: 'Accent sur "NOG" : "eye-kon-OG-ruh-fi". Le "i" initial se prononce "eye". Le "g" est dur. Ne dites pas "ee-kon-oh-GRAF-ee" à la française.',
    },
    {
      word: 'Enculturation',
      phonetic: '/ɪnˌkʌltʃəˈreɪʃən/',
    ...
    },
    {
      ...
      phonetic: '/ˌsoʊsioʊlɪŋˈɡwɪstɪks/',
      meaning: 'Sociolinguistique',
      tip: 'Accent principal sur "GWIS" : "so-see-oh-lin-GWIS-tiks". Le "o" de "socio" est long. Le "g" devant "w" est dur. Ne dites pas "so-see-oh-lan-GWIS-tiks".',
    },
  ],
}
