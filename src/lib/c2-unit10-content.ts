  ...
  vocab: [
    {
      ...
      french: 'Prosodie',
      phonetic: '/ˈprɒsədi/',
      example: 'The prosody of political oratory — the rhythmic cadences, the strategic pauses, the modulations of pitch — is as calculated as any policy position.',
      exampleTranslation: 'La prosodie de l\'oratoire politique — les cadences rythmiques, les pauses stratégiques, les modulations de hauteur — est aussi calculée que toute position politique.',
    },
    {
      english: 'Cadence',
      french: 'Cadence (oratoire)',
      phonetic: '/ˈkeɪdəns/',
      example: 'The senator\'s closing cadence — a slow, descending tricolon — carried the weight of inevitability that no amount of counter-argument could dispel.',
      exampleTranslation: 'La cadence conclusive du sénateur — un tricolone lent et descendant — portait le poids de l\'inévitabilité qu\'aucun contre-argument ne pouvait dissiper.',
    },
    {
      english: 'Register',
      french: 'Registre (de langue)',
      phonetic: '/ˈrɛdʒɪstər/',
      example: 'The ability to shift register — from the elevated rhetoric of a convention speech to the colloquial directness of a town hall — is what distinguishes the skilled politician from the mere demagogue.',
      exampleTranslation: 'La capacité de changer de registre — de la rhétorique élevée d\'un discours de convention à la directitude familière d\'une assemblée publique — est ce qui distingue le politicien habile du simple démagogue.',
    },
    {
      english: 'Inflection',
      french: 'Inflexion (de la voix)',
      phonetic: '/ɪnˈflɛkʃən/',
      example: 'A single inflection — the rising pitch on "really?" that signals not inquiry but incredulity — can demolish an opponent\'s credibility more effectively than a thousand words of rebuttal.',
      exampleTranslation: 'Une seule inflexion — la hauteur montante sur "really ?" qui signale non pas l\'interrogation mais l\'incrédulité — peut démolir la crédibilité d\'un adversaire plus efficacement que mille mots de réfutation.',
    },
    {
      english: 'Timbre',
  ...
  pronunciation: [
    {
      ...
      phonetic: '/ˈprɒsədi/',
      meaning: 'Prosodie',
      tip: 'Accent sur la première syllabe : "PRO-seh-di". Le "o" est ouvert comme dans "hot". Les deux dernières syllabes se réduisent. Ne dites pas "pro-SO-di" — l\'accent est toujours sur la première syllabe en anglais.',
    },
    {
      word: 'Cadence',
      phonetic: '/ˈkeɪdəns/',
      meaning: 'Cadence (oratoire)',
      tip: 'Accent sur "KAY" : "KAY-dens". Le "a" est long comme dans "play". Le "e" final est réduit. En contexte oratoire, cette syllabe accentuée peut être prolongée pour un effet dramatique : "KAAAAY-dens".',
    },
    {
      word: 'Inflection',
      phonetic: '/ɪnˈflɛkʃən/',
      meaning: 'Inflexion (de la voix)',
      tip: 'Accent sur "FLEK" : "in-FLEK-shun". Le "i" initial est réduit. Le "e" accentué est court et ouvert comme dans "bed". Le "tion" = "shun". En contexte politique, l\'accent sur "FLEK" peut être emphatisé pour signaler l\'importance du changement vocal.',
    },
    {
      word: 'Timbre',
      phonetic: '/ˈtæmbər/',
