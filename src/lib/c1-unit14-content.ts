...
export const C1_L66: LessonContent = {
  vocab: [
    ...
    { english: 'euphemism', french: 'euphémisme', phonetic: '/ˈjuːfəmɪzəm/', example: '« Let go » is a euphemism for « fire someone ».', exampleTranslation: '« Let go » est un euphémisme pour « licencier quelqu\'un ».' },
    ...
    { english: 'idiom', french: 'idiome / expression idiomatique', phonetic: '/ˈɪdiəm/', example: '« Break a leg » is an idiom meaning « good luck », especially in theatre.', exampleTranslation: '« Break a leg » est un idiome signifiant « bonne chance », surtout au théâtre.' },
  ...
  grammar: {
    title: 'Typologie des expressions anglaises : colloquialism, euphemism, phrasal verb, idiom, proverb',
    explanation: 'L\'anglais regorge d\'expressions qu\'il faut savoir distinguer pour les employer à bon escient : (1) Colloquialism = expression familière propre au langage parlé : « gonna », « wanna », « ain\'t », « buck » (dollar). Ce n\'est PAS incorrect, c\'est le registre informel. On ne les écrit pas dans un essai académique, mais ils sont omniprésents à l\'oral. (2) Euphemism = terme atténué pour remplacer un mot jugé trop direct ou choquant : « pass away » (mourir), « let go » (licencier), « between jobs » (au chômage). L\'euphémisme est une stratégie sociale — il adoucit la réalité. (3) Phrasal verb = verbe + particule (adverbe ou préposition) dont le sens est souvent compositionnel ou semi-figé : « look up » (chercher), « take off » (enlever / décoller). Attention : certains phrasal verbs SONT aussi des idiomes quand leur sens est totalement opaque. (4) Idiom = expression figée dont le sens global ne se déduit PAS des mots individuels : « kick the bucket » (mourir), « spill the beans » (révéler un secret). Si on comprend chaque mot mais pas le sens global, c\'est un idiome. (5) Proverb = sentence morale ou sagesse populaire complète : « Too many cooks spoil the broth ». Un proverbe est autonome et exprime une vérité générale, tandis qu\'un idiome s\'intègre dans une phrase.',
    examples: [
      { sentence: '« Kick the bucket » is an idiom, not a colloquialism — its meaning cannot be deduced from the individual words.', translation: '« Kick the bucket » est un idiome, pas un colloquialisme — son sens ne peut se déduire des mots individuels.', isCorrect: true },
      { sentence: '« Pass away » is a euphemism that softens the bluntness of « die ».', translation: '« Pass away » est un euphémisme qui adoucit la brutalité de « die ».', isCorrect: true },
      { sentence: '« A bird in the hand is worth two in the bush » is an idiom about being cautious.', translation: '', isCorrect: false },
    ...
    commonMistakes: [
      { wrong: '« A bird in the hand is worth two in the bush » is an idiom about being cautious.', correct: '« A bird in the hand is worth two in the bush » is a proverb about valuing what you already have.', explanation: 'Un proverbe (proverb) est une sentence morale complète et autonome. Un idiome (idiom) est une expression figée qui s\'intègre dans une phrase. Cette citation est un proverbe — elle exprime une vérité générale par elle-même.' },
      { wrong: '« Gonna » is an idiom for « going to ».', correct: '« Gonna » is a colloquialism — an informal spoken contraction of « going to ».', explanation: '« Gonna » n\'est PAS un idiome : son sens est parfaitement transparent (c\'est simplement une contraction). C\'est un colloquialisme — un trait du registre familier oral.' },
    ],
  },
  conversation: [
    { speaker: 'Professor Lambert', role: 'A', text: 'Today we\'re going to unpack the differences between colloquialisms, euphemisms, phrasal verbs, idioms, and proverbs. Can anyone give me an example of each?', translation: 'Aujourd\'hui, nous allons démêler les différences entre colloquialismes, euphémismes, verbes à particule, idiomes et proverbes. Quelqu\'un peut-il me donner un exemple de chacun ?' },
    { speaker: 'Student Marine', role: 'B', text: 'A colloquialism would be « bucks » for dollars. A euphemism — « between jobs » instead of « unemployed ».', translation: 'Un colloquialisme serait « bucks » pour dollars. Un euphémisme — « between jobs » au lieu de « unemployed ».' },
    { speaker: 'Professor Lambert', role: 'A', text: 'Excellent. And the crucial difference between a phrasal verb and an idiom?', translation: 'Excellent. Et la différence cruciale entre un verbe à particule et un idiome ?' },
    { speaker: 'Student Marine', role: 'B', text: 'A phrasal verb like « look up » still has a semi-literal connection — you\'re directing your gaze upward metaphorically. But « kick the bucket » has nothing to do with buckets or kicking.', translation: 'Un verbe à particule comme « look up » garde un lien semi-littéral — on dirige son regard vers le haut métaphoriquement. Mais « kick the bucket » n\'a rien à voir avec des seaux ou des coups de pied.' },
    ...
    { speaker: 'Student Marine', role: 'B', text: 'So the hierarchy is: colloquialisms shift register, euphemisms soften reality, phrasal verbs combine literally or semi-literally, idioms are opaque, and proverbs are self-contained wisdom?', translation: 'Donc la hiérarchie est : les colloquialismes changent le registre, les euphémismes adoucissent la réalité, les verbes à particule se combinent littéralement ou semi-littéralement, les idiomes sont opaques, et les proverbes sont des sagesses autonomes ?' },
  ],
  ...
  pronunciation: [
    ...
    { word: 'Euphemism', phonetic: '/ˈjuːfəmɪzəm/', meaning: 'Euphémisme', tip: 'Prononcez « YOO-fuh-miz-um » — l\'accent est sur « YOO ». Le « eu » initial se prononce « you » comme dans « euphoria ». Ne dites pas « eu-fe-misme » à la française.' },
    { word: 'Idiom', phonetic: '/ˈɪdiəm/', meaning: 'Idiome', tip: 'Prononcez « ID-ee-um » — l\'accent est sur « ID ». Ne dites pas « i-di-OM » avec l\'accent sur la dernière syllabe. Le « i » initial est court comme dans « bit ».' },
