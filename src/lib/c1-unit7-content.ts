...
export const C1_L31: LessonContent = {
  vocab: [
    ...
    { english: 'validation', french: 'validation / vérification de conformité', phonetic: '/ˌvælɪˈdeɪʃn/', example: 'Validation of the test results is required before the product can be released.', exampleTranslation: 'La validation des résultats de test est requise avant que le produit puisse être commercialisé.' },
