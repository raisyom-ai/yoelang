...
export const C2_L62: LessonContent = {
  vocab: [
    ...
    { english: 'heuristic', french: 'heuristique', phonetic: '/hjʊˈrɪstɪk/', example: 'While imperfect, the heuristic provides a workable approximation where formal models are intractable.', exampleTranslation: 'Bien qu\'imparfait, l\'heuristique fournit une approximation exploitable là où les modèles formels sont insolubles.' },
  ],
  grammar: {
  ...
  conversation: [
    ...
    { speaker: 'Dr. Okonkwo', role: 'A', text: 'Exactly. The heuristic we\'re employing works well as a proof of concept, but scaling it introduces variables we can\'t yet fully model.', translation: 'Exactement. L\'heuristique que nous employons fonctionne bien comme preuve de concept, mais la mise à l\'échelle introduit des variables que nous ne pouvons pas encore modéliser complètement.' },
  ...
  pronunciation: [
    ...
    { word: 'Heuristic', phonetic: '/hjʊˈrɪstɪk/', meaning: 'Heuristique', tip: 'Le « h » est expiré et le « eu » sonne comme « you » : « hyou-RIS-tik ». L\'accent est sur la deuxième syllabe. Ne rendez pas le « h » muet.' },
