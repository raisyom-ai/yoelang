...
export const B2_L20: LessonContent = {
  vocab: [
    ...
    { english: 'sovereignty', french: 'souveraineté', phonetic: '/ˈsɒvrɪnti/', example: 'The question of sovereignty lies at the heart of political philosophy.', exampleTranslation: 'La question de la souveraineté se trouve au cœur de la philosophie politique.' },
  ...
  grammar: {
    ...
    explanation: 'Les termes philosophiques anglais sont souvent des emprunts au grec ou au latin, et leur prononciation diffère radicalement du français : (1) « Epistemology » : /ɪˌpɪstəˈmɒlədʒi/ — l\'accent est sur « MOL », pas sur « pis » comme en français. Le « e » initial est un schwa court. (2) « Metaphysics » : /ˌmetəˈfɪzɪks/ — l\'accent est sur « FIZ », le « y » se prononce « ih » (pas « i » français). La terminaison « -ics » se prononce « iks », pas « ik ». (3) « Sovereignty » : /ˈsɒvrɪnti/ — le « eig » est SILENT ! On prononce « SOV-rin-ti », pas « sov-rein-ti ». C\'est l\'un des mots les plus piégés pour les francophones. (4) « Autonomy » : /ɔːˈtɒnəmi/ — l\'accent est sur « TON », pas sur « au » comme en français. (5) « Dogma » : /ˈdɒɡmə/ — le « g » est dur comme dans « go », pas doux comme en français « dog-me ». Règle générale : les mots savants partagés entre l\'anglais et le français ont presque toujours l\'accent sur une syllabe différente.',
    examples: [
  ...
  pronunciation: [
    ...
    { word: 'Sovereignty', phonetic: '/ˈsɒvrɪnti/', meaning: 'Souveraineté', tip: 'PIÈGE MAJEUR : le « eig » est MUET ! Prononcez « SOV-rin-ti », en seulement 3 syllabes. Ne dites JAMAIS « so-vrein-ti » — c\'est la faute la plus courante des francophones sur ce mot.' },
