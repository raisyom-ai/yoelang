...
export const C2_L26: LessonContent = {
  vocab: [
    ...
    },
    {
      ...
      french: 'Taxonomie',
      phonetic: '/tækˈsɒnəmi/',
      example: 'Bloom\'s taxonomy of educational objectives has been so widely adopted that it has arguably become a straitjacket.',
      exampleTranslation: 'La taxonomie des objectifs pédagogiques de Bloom a été si largement adoptée qu\'elle est sans doute devenue une camisole de force.',
    },
    {
      english: 'Jargon',
      french: 'Jargon',
    ...
    },
    {
      ...
      french: 'Ontologie',
      phonetic: '/ɒnˈtɒlədʒi/',
      example: 'In information science, an ontology specifies the conceptualisations that a community agrees to share.',
      exampleTranslation: 'En science de l\'information, une ontologie spécifie les conceptualisations qu\'une communauté accepte de partager.',
    },
  ],
  grammar: {
  ...
  pronunciation: [
    ...
    },
    {
      ...
      phonetic: '/ɒnˈtɒlədʒi/',
      meaning: 'Ontologie',
      tip: 'Accent sur "TOL" : "on-TOL-eh-dji". Le "g" est doux comme dans "gem". Le premier "o" est réduit, le "o" accentué est ouvert comme dans "hot".',
    },
  ],
}
  ...
  vocab: [
    {
      ...
      example: 'Greenberg\'s linguistic typology classifies languages by word order rather than by genealogical descent.',
      exampleTranslation: 'La typologie linguistique de Greenberg classe les langues par ordre des mots plutôt que par descendance généalogique.',
    },
    {
      english: 'Paradigm',
      french: 'Paradigme',
  ...
  pronunciation: [
    {
      ...
      phonetic: '/taɪˈpɒlədʒi/',
      meaning: 'Typologie',
      tip: 'Accent sur "POL" : "taï-POL-eh-dji". Le "y" initial = "aï". Le "g" est doux comme dans "gem". Ne dites pas "ti-po-LO-dji".',
    },
    {
      word: 'Paradigm',
      phonetic: '/ˈpærədaɪm/',
...
export const C2_L28: LessonContent = {
  vocab: [
    ...
    },
    {
      ...
      phonetic: '/hɜːrˈmjuːtɪk/',
      example: 'The hermeneutic circle — understanding the whole through its parts and the parts through the whole — is not a vicious circle but a spiral of deepening comprehension.',
      exampleTranslation: 'Le cercle herméneutique — comprendre le tout par ses parties et les parties par le tout — n\'est pas un cercle vicieux mais une spirale d\'approfondissement de la compréhension.',
    },
    {
      english: 'Dialectic',
      french: 'Dialectique',
      phonetic: '/ˌdaɪəˈlɛktɪk/',
      example: 'The dialectic between theory and praxis is not a contradiction to be resolved but a productive tension to be sustained.',
      exampleTranslation: 'La dialectique entre théorie et praxis n\'est pas une contradiction à résoudre mais une tension productive à entretenir.',
    },
    {
      english: 'Praxis',
      french: 'Praxis',
      phonetic: '/ˈpræksɪs/',
      example: 'Freire\'s praxis-oriented pedagogy insists that reflection without action is verbalism, and action without reflection is activism.',
      exampleTranslation: 'La pédagogie orientée vers la praxis de Freire affirme que la réflexion sans action est du verbalisme, et l\'action sans réflexion de l\'activisme.',
    },
  ],
  grammar: {
    ...
    examples: [
      { sentence: 'While the dialectic approach admittedly risks circularity, it remains the case that it captures the dynamic interplay between theory and praxis more adequately than static models.', translation: 'Bien que l\'approche dialectique risque admissible la circularité, il n\'en demeure pas moins qu\'elle saisit l\'interaction dynamique entre théorie et praxis plus adéquatement que les modèles statiques.', isCorrect: true },
      ...
      { sentence: 'He argues that the hermeneutic circle is a vicious circle, but he would counter that it is a spiral.', translation: '', isCorrect: false },
  ...
  conversation: [
    ...
    { speaker: 'Dr. Laurent', role: 'B', text: 'Provided, of course, that the heuristic doesn\'t harden into dogma. The hermeneutic tradition reminds us that our interpretive frameworks must remain open to revision.', translation: 'Pourvu, bien sûr, que l\'heuristique ne se fige pas en dogme. La tradition herméneutique nous rappelle que nos cadres interprétatifs doivent demeurer ouverts à la révision.', },
    { speaker: 'Prof. Ndiaye', role: 'A', text: 'Which brings us to praxis. The gap between theoretical insight and institutional implementation is where most ambitious frameworks falter.', translation: 'Ce qui nous mène à la praxis. C\'est dans l\'écart entre l\'aperçu théorique et l\'implémentation institutionnelle que la plupart des cadres ambitieux trébuchent.', },
    { speaker: 'Dr. Laurent', role: 'B', text: 'Indeed. Freire\'s insistence on praxis — on the unity of reflection and action — remains the most cogent response to the perennial charge that theory is merely academic.', translation: 'En effet. L\'insistance de Freire sur la praxis — sur l\'unité de la réflexion et de l\'action — demeure la réponse la plus convaincante à l\'accusation récurrente selon laquelle la théorie serait purement académique.', },
    { speaker: 'Prof. Ndiaye', role: 'A', text: 'And yet, as we both know, praxis without rigorous theoretical grounding risks becoming mere activism. The dialectic, it seems, is inescapable — and perhaps that is as it should be.', translation: 'Et pourtant, comme nous le savons tous deux, la praxis sans fondement théorique rigoureux risque de devenir de la simple activism. La dialectique, semble-t-il, est inéluctable — et c\'est peut-être ainsi qu\'il faut.', },
  ],
  conversationTitle: 'Épistémè, dialectique et praxis',
  pronunciation: [
    {
      word: 'Episteme',
      phonetic: '/ɪˈpɪstiːmi/',
    ...
    },
    {
      ...
      phonetic: '/ˈpræksɪs/',
      meaning: 'Praxis',
      tip: 'Accent sur la première syllabe : "PRAK-sis". Le "x" = "ks". Le "a" est ouvert comme dans "cat". Ne dites pas "PRAHK-sis" — la voyelle est courte et ouverte.',
    },
  ],
}
