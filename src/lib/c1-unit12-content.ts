...
export const C1_L56: LessonContent = {
  vocab: [
    { english: 'empirical', french: 'empirique', phonetic: '/ɪmˈpɪrɪkl/', example: 'The study relies on empirical evidence gathered from longitudinal field observations.', exampleTranslation: 'L\'étude repose sur des preuves empiriques recueillies lors d\'observations longitudinales sur le terrain.' },
    ...
    { english: 'paradigm', french: 'paradigme', phonetic: '/ˈpærədaɪm/', example: 'The discovery of quantum mechanics represented a paradigm shift in physics.', exampleTranslation: 'La découverte de la mécanique quantique a représenté un changement de paradigme en physique.' },
    { english: 'hypothesis', french: 'hypothèse', phonetic: '/haɪˈpɒθəsɪs/', example: 'The null hypothesis was rejected at the 0.01 significance level.', exampleTranslation: 'L\'hypothèse nulle a été rejetée au seuil de signification 0,01.' },
    { english: 'methodology', french: 'méthodologie', phonetic: '/ˌmeθəˈdɒlədʒi/', example: 'The methodology employed a mixed-methods approach combining surveys and interviews.', exampleTranslation: 'La méthodologie a employé une approche mixte combinant enquêtes et entretiens.' },
  ],
  grammar: {
    title: 'Le vocabulaire scientifique avancé : nuances entre termes empiriques et théoriques',
    explanation: 'Le discours scientifique anglais exige une précision terminologique rigoureuse : (1) « Empirical » ≠ « theoretical » ≠ « speculative » : empirical = fondé sur l\'observation et l\'expérience ; theoretical = fondé sur la théorie et le raisonnement ; speculative = hypothétique, sans preuve solide. On ne dit pas « empirical theory » (contradiction), on dit « empirically grounded theory ». (2) « Hypothesis » ≠ « theory » ≠ « law » : une hypothesis est une conjecture testable ; une theory est un ensemble cohérent d\'hypothèses validées ; une law est une régularité universellement observée. Attention : « theory » en anglais scientifique ≠ « théorie » en français (spéculation) — en anglais, « theory » est robuste. (3) « Paradigm » se construit avec « shift » : « a paradigm shift » = un changement de paradigme. On dit aussi « within the current paradigm » = dans le paradigme actuel. (4) « Methodology » ≠ « method » : une methodology est l\'étude des méthodes ou le cadre méthodologique global ; une method est une technique spécifique. On ne dit pas « the methodology we used was a questionnaire » mais « the method we used was a questionnaire » ; « the methodology » désigne l\'approche d\'ensemble. (5) « Data » est techniquement un pluriel en latin (singulier : datum), donc « the data are » en style scientifique formel, bien que « the data is » soit courant à l\'oral.',
    examples: [
      { sentence: 'The empirical findings support the theoretical model proposed by Chen et al.', translation: 'Les résultats empiriques soutiennent le modèle théorique proposé par Chen et al.', isCorrect: true },
      { sentence: 'The methodology we used was a semi-structured interview.', translation: '', isCorrect: false },
      { sentence: 'A paradigm shift occurs when anomalies can no longer be accommodated within the existing framework.', translation: 'Un changement de paradigme se produit lorsque les anomalies ne peuvent plus être intégrées dans le cadre existant.', isCorrect: true },
      { sentence: 'The data are consistent with the hypothesis that cognitive load impairs decision-making.', translation: 'Les données sont cohérentes avec l\'hypothèse selon laquelle la charge cognitive altère la prise de décision.', isCorrect: true },
    ],
    commonMistakes: [
      { wrong: 'The methodology we used was a semi-structured interview.', correct: 'The method we used was a semi-structured interview; our methodology was qualitative.', explanation: '« Methodology » est le cadre méthodologique global (l\'approche), pas une technique spécifique. Un entretien semi-directif est une « method ». La « methodology » serait par exemple « a qualitative methodology » ou « a mixed-methods methodology ».' },
      { wrong: 'It\'s just a theory.', correct: 'It\'s a well-established theory with substantial empirical support.', explanation: 'En anglais scientifique, « theory » n\'est pas une simple spéculation (contrairement à l\'usage courant et au faux ami français). Une « scientific theory » est un cadre explicatif robuste, validé par des preuves empiriques. Dire « just a theory » est trompeur dans un contexte scientifique.' },
    ],
  },
  conversation: [
    { speaker: 'Dr. Lambert', role: 'A', text: 'We need to reassess our methodology. The empirical data from the pilot study don\'t align with our theoretical predictions.', translation: 'Nous devons réévaluer notre méthodologie. Les données empiriques de l\'étude pilote ne correspondent pas à nos prédictions théoriques.' },
    { speaker: 'Prof. Nakamura', role: 'B', text: 'That\'s not necessarily a problem. Anomalies can point to a more nuanced hypothesis rather than invalidate the entire paradigm.', translation: 'Ce n\'est pas nécessairement un problème. Les anomalies peuvent indiquer une hypothèse plus nuancée plutôt qu\'invalider le paradigme entier.' },
    { speaker: 'Dr. Lambert', role: 'A', text: 'True. But if we\'re operating within the positivist paradigm, shouldn\'t the data take precedence over theoretical elegance?', translation: 'Vrai. Mais si nous opérons dans le paradigme positiviste, les données ne devraient-elles pas primer sur l\'élégance théorique ?' },
    { speaker: 'Prof. Nakamura', role: 'B', text: 'Only if the methods used to collect those data are robust. What was the sample size in the pilot?', translation: 'Seulement si les méthodes utilisées pour recueillir ces données sont robustes. Quelle était la taille de l\'échantillon dans le pilote ?' },
    { speaker: 'Dr. Lambert', role: 'A', text: 'Two hundred and thirty participants. The method was a randomised controlled trial, so the design is sound.', translation: 'Deux cent trente participants. La méthode était un essai contrôlé randomisé, donc le protocole est solide.' },
    { speaker: 'Prof. Nakamura', role: 'B', text: 'Then we may indeed be looking at something significant. Let\'s formulate an alternative hypothesis and design a follow-up study.', translation: 'Alors nous observons peut-être quelque chose de significatif. Formulons une hypothèse alternative et concevons une étude de suivi.' },
  ],
  conversationTitle: 'Confrontation empirique vs. théorique : évaluation méthodologique',
  pronunciation: [
    { word: 'Empirical', phonetic: '/ɪmˈpɪrɪkl/', meaning: 'Empirique', tip: 'L\'accent est sur « PIR » : « im-PIR-ik-ul ». Le « e » initial est réduit. Ne dites pas « em-pee-REE-kal » à la française. Le « pi » rime avec « pir » de « spirit ».' },
    { word: 'Paradigm', phonetic: '/ˈpærədaɪm/', meaning: 'Paradigme', tip: 'Prononcez « PA-ruh-dyme » — l\'accent est sur « PA ». La dernière syllabe rime avec « dime » ou « time ». Ne prononcez PAS le « g » : ce n\'est PAS « pa-ra-dig-me ».' },
    { word: 'Hypothesis', phonetic: '/haɪˈpɒθəsɪs/', meaning: 'Hypothèse', tip: 'L\'accent est sur « PO » : « hy-POTH-uh-sis ». Le « hy » se prononce « haï » comme dans « hyper ». Le « th » est interdentale expirée. Le pluriel « hypotheses » = « hy-POTH-uh-seez ».' },
    { word: 'Methodology', phonetic: '/ˌmeθəˈdɒlədʒi/', meaning: 'Méthodologie', tip: 'L\'accent est sur « DOL » : « meth-uh-DOL-uh-jee ». Ne mettez pas l\'accent sur « me » comme en français. Le « th » est expiré comme dans « think ».' },
  ],
}
...
export const C1_L60: LessonContent = {
  vocab: [
    { english: 'phenomenon', french: 'phénomène', phonetic: '/fɪˈnɒmɪnən/', example: 'The phenomenon was first documented in the early twentieth century.', exampleTranslation: 'Le phénomène a été documenté pour la première fois au début du vingtième siècle.' },
    ...
    { english: 'epistemology', french: 'épistémologie', phonetic: '/ɪˌpɪstɪˈmɒlədʒi/', example: 'The epistemology of social science differs fundamentally from that of natural science.', exampleTranslation: 'L\'épistémologie des sciences sociales diffère fondamentalement de celle des sciences naturelles.' },
  ],
  grammar: {
    title: 'La prononciation scientifique : pièges pour francophones dans les termes savants',
    explanation: 'Les termes scientifiques anglais sont truffés de pièges phonétiques pour les francophones, car beaucoup viennent du grec ou du latin et suivent des règles de prononciation anglaises : (1) « Phenomenon » : /fɪˈnɒmɪnən/ — le « ph » = « f » (pas « p »), l\'accent est sur « NOM » (pas sur la première syllabe comme en français), le pluriel irrégulier est « phenomena » /fɪˈnɒmɪnə/ (pas « phenomenons »). (2) « Chlorophyll » : /ˈklɒrəfɪl/ — le « ch » = « k » (comme dans « chemistry »), pas « ch » français. Le « ph » = « f ». L\'accent est sur « CLO » (première syllabe). (3) « Synthesis » : /ˈsɪnθəsɪs/ — le « y » = « i » court (pas « u » français), le « th » est interdentale expirée (pas « s » ou « z »), l\'accent est sur « SIN ». Le pluriel « syntheses » = /ˈsɪnθəsiːz/. (4) « Algorithm » : /ˈælɡərɪðəm/ — le « al » est ouvert comme dans « Alice » (pas « al » français), le « th » est interdentale expirée, l\'accent est sur « AL ». (5) « Epistemology » : /ɪˌpɪstɪˈmɒlədʒi/ — le « e » initial est réduit, l\'accent principal est sur « MOL », le « st » ne se fait pas sauter. Règle générale : en anglais, le « th » /θ/ est toujours expiré dans les termes scientifiques (hypothesis, synthesis, algorithm), jamais remplacé par « s » ou « z ».',
    examples: [
      { sentence: 'The phenomenon has been observed across multiple experimental conditions.', translation: 'Le phénomène a été observé dans de multiples conditions expérimentales.', isCorrect: true },
      ...
      { sentence: 'The phenomenons observed in the study were unexpected.', translation: '', isCorrect: false },
      { sentence: 'The algorithm processes epistemological assumptions embedded in the data.', translation: 'L\'algorithme traite les hypothèses épistémologiques intégrées dans les données.', isCorrect: true },
    ],
    commonMistakes: [
      { wrong: 'The phenomenons observed in the study were unexpected.', correct: 'The phenomena observed in the study were unexpected.', explanation: '« Phenomenon » a un pluriel irrégulier d\'origine grecque : « phenomena » (pas « phenomenons »). De même : criterion → criteria ; stimulus → stimuli ; datum → data. Ces pluriels irréguliers sont la norme en anglais scientifique.' },
  ...
  conversation: [
    { speaker: 'Dr. Fournier', role: 'A', text: 'I struggled with the pronunciation during my presentation — I said « fe-nom-e-non » instead of « fi-NOM-i-non » and the audience looked confused.', translation: 'J\'ai eu du mal avec la prononciation pendant ma présentation — j\'ai dit « fe-nom-e-non » au lieu de « fi-NOM-i-non » et le public avait l\'air confus.' },
    { speaker: 'Dr. Williams', role: 'B', text: 'That\'s a common issue. The Greek-origin terms follow English stress patterns, not French. « Phenomenon » stresses the second syllable, and the « ph » is an « f » sound.', translation: 'C\'est un problème courant. Les termes d\'origine grecque suivent les patrons d\'accent anglais, pas français. « Phenomenon » accentue la deuxième syllabe, et le « ph » se prononce « f ».' },
    ...
    { speaker: 'Dr. Fournier', role: 'A', text: 'What about « epistemology »? I find the stress pattern particularly tricky.', translation: 'Et « epistemology » ? Je trouve le schéma d\'accent particulièrement délicat.' },
    { speaker: 'Dr. Williams', role: 'B', text: 'Break it down: « ih-pis-teh-MOL-uh-jee » — primary stress on « MOL », secondary on « pis ». And don\'t drop the « s » — say « pis », not « pi ». Practice with: biology, geology, epistemology — they all follow the same pattern.', translation: 'Décomposez : « ih-pis-teh-MOL-uh-jee » — accent principal sur « MOL », accent secondaire sur « pis ». Et ne supprimez pas le « s » — dites « pis », pas « pi ». Entraînez-vous avec : biology, geology, epistemology — ils suivent tous le même schéma.' },
  ],
  conversationTitle: 'Prononciation scientifique : conseils pour francophones',
  pronunciation: [
    { word: 'Phenomenon', phonetic: '/fɪˈnɒmɪnən/', meaning: 'Phénomène', tip: 'Prononcez « fi-NOM-i-nun » — l\'accent est sur « NOM », pas sur la première syllabe comme en français. Le « ph » = « f ». Le pluriel « phenomena » = « fi-NOM-i-nuh ».' },
