  ...
  vocab: [
    {
      ...
      french: 'Strophe',
      phonetic: '/ˈstænzə/',
      example: 'The stanza across lines four and five propels the reader forward, denying the syntactic closure the line break would otherwise promise.',
      exampleTranslation: 'La strophe entre les vers quatre et cinq propulse le lecteur en avant, déniant la clôture syntaxique que le retour à la ligne promettrait autrement.',
    },
    {
      english: 'Metrical foot',
      french: 'Pied métrique',
      phonetic: '/ˈmɛtrɪkəl fʊt/',
      example: 'The metrical foot after "married" creates an agonising pause that mirrors the speaker\'s hesitation.',
      exampleTranslation: 'Le pied métrique après "married" crée une pause angoissante qui reflète l\'hésitation du locuteur.',
    },
    {
      english: 'Consonance',
      french: 'Consonance',
      phonetic: '/ˈkɒnsənəns/',
      example: 'The relentless consonance of plosive "p" sounds in Poe\'s "The Bells" imitates the very percussion it describes.',
      exampleTranslation: 'La consonance implacable des consonnes occlusives "p" dans "The Bells" de Poe imite la percussion même qu\'elle décrit.',
    },
    {
  ...
  pronunciation: [
    {
      ...
      phonetic: '/ˈstænzə/',
      meaning: 'Strophe',
      tip: 'Accent sur "STAN" : "STAN-zuh". Le "a" est très ouvert comme dans "cat". Le "z" est sonore. Ne dites pas "stahn-ZAH" à la française.',
    },
    {
      word: 'Caesura',
      phonetic: '/sɪˈʒʊərə/',
...
export const C2_L37: LessonContent = {
  vocab: [
    ...
    {
      english: 'Apostrophe',
      french: 'Apostrophe (rhétorique)',
      phonetic: '/əˈpɒstrəfi/',
      example: 'The apostrophe in "O Wild West Wind" — addressing an absent force as though present — converts description into invocation, enacting in form the urgency it describes.',
      exampleTranslation: 'L\'apostrophe dans "O Wild West Wind" — s\'adressant à une force absente comme si elle était présente — convertit la description en invocation, accomplissant dans la forme l\'urgence qu\'elle décrit.',
    },
    {
      english: 'Archaism',
      french: 'Archaisme',
    ...
    {
      english: 'Ploce',
      french: 'Plocé (répétition à valeur différente)',
      phonetic: '/ˈplɒsi/',
      example: 'Ploce, as in "The man is not the man he was", forces a single word to carry two incompatible meanings within the same utterance.',
      exampleTranslation: 'La plocé, comme dans "The man is not the man he was", force un seul mot à porter deux sens incompatibles au sein d\'un même énoncé.',
    },
    {
      english: 'Anastrophe',
  ...
  pronunciation: [
    ...
    },
    {
      ...
      phonetic: '/əˈnæfərə/',
      meaning: 'Anaphore',
      tip: 'Accent sur la deuxième syllabe : "uh-NAF-er-uh". Le "ph" grec se prononce "f". Ne dites pas "a-na-FOR-a".',
    },
    {
      word: 'Archaism',
      phonetic: '/ˈɑːrkeɪɪzəm/',
...
export const C2_L38: LessonContent = {
  vocab: [
    {
      english: 'Reading protocol',
      french: 'Protocole de lecture',
      phonetic: '/ˈriːdɪŋ ˈproʊtəkɒl/',
      example: 'A reading protocol determines the set of questions, assumptions, and methods the critic brings to a text — and thereby shapes what can be discovered.',
      exampleTranslation: 'Un protocole de lecture détermine l\'ensemble des questions, présuppositions et méthodes que le critique apporte à un texte — et façonne ainsi ce qui peut être découvert.',
    },
    {
      english: 'Multivalence',
      french: 'Multivalence',
      phonetic: '/ˌmʌltɪˈveɪləns/',
      example: 'The multivalence of poetic language means that a single image can sustain moral, aesthetic, and autobiographical readings simultaneously.',
      exampleTranslation: 'La multivalence du langage poétique signifie qu\'une seule image peut soutenir simultanément des lectures morales, esthétiques et autobiographiques.',
    },
    {
  ...
  conversation: [
    ...
    { speaker: 'Olivier', role: 'B', text: 'One could begin with a reading protocol — read the parts provisionally, construct a tentative whole, then return to the parts with that whole in view and revise.', translation: 'On pourrait commencer par un protocole de lecture — lire les parties provisoirement, construire un tout provisoire, puis revenir aux parties avec ce tout en vue et réviser.', },
    { speaker: 'Amara', role: 'A', text: 'But isn\'t that precisely where multivalence becomes generative rather than obstructive? The richest poems are those where meaning radiates in several directions and no single reading cancels the others.', translation: 'Mais n\'est-ce pas précisément là que la multivalence devient générative plutôt qu\'obstructive ? Les poèmes les plus riches sont ceux où le sens rayonne dans plusieurs directions et aucune lecture n\'annule les autres.', },
    ...
    { speaker: 'Amara', role: 'A', text: 'Which is arguably why any reading that claims to have "cracked" the poem has already betrayed it. The poem is its multivalence, not a puzzle to be solved.', translation: 'Ce qui est sans doute la raison pour laquelle toute lecture qui prétend avoir "décrypté" le poème l\'a déjà trahi. Le poème est sa multivalence même, non une énigme à résoudre.', },
  ],
  conversationTitle: 'Interpréter la poésie',
  pronunciation: [
    {
      word: 'Reading protocol',
      phonetic: '/ˈriːdɪŋ ˈproʊtəkɒl/',
      meaning: 'Protocole de lecture',
      tip: 'Accent principal sur "PRO" : "REE-ding PRO-tuh-kol". Le "o" de "pro" est long comme dans "go". Le "col" final a un "o" ouvert comme dans "hot".',
    },
    {
      word: 'Multivalence',
      phonetic: '/ˌmʌltɪˈveɪləns/',
      meaning: 'Multivalence',
      tip: 'Accent sur "VAY" : "mul-tih-VAY-lens". Le "u" est court comme dans "cup". Le "a" accentué est long comme dans "day". Le suffixe "-ence" se prononce "ens".',
    },
    {
...
export const C2_L39: LessonContent = {
  vocab: [
    ...
    },
    {
      ...
      phonetic: '/ˌvɜːrsɪfɪˈkeɪʃən/',
      example: 'Versification governs the formal principles of verse composition — metre, rhyme scheme, stanza form, and the rules governing their combination.',
      exampleTranslation: 'La versification régit les principes formels de la composition des vers — le mètre, le schéma rimique, la forme strophique et les règles régissant leur combinaison.',
    },
  ],
  grammar: {
    ...
    commonMistakes: [
      ...
      { wrong: 'The poem has a nice rhythm.', correct: 'The versification — a regular iambic pentameter punctuated by strategically placed spondees — enacts through its rhythmic variation the tension between order and disruption that structures the poem.', explanation: '"Nice rhythm" est une appréciation sans valeur analytique. La critique C2 doit identifier le mètre, ses variations, et montrer comment la versification accomplit ("enacts") le contenu sémantique du poème.' },
    ],
  },
  conversation: [
  ...
  pronunciation: [
    ...
    },
    {
      word: 'Versification',
      phonetic: '/ˌvɜːrsɪfɪˈkeɪʃən/',
      meaning: 'Versification',
      tip: 'Accent sur "KAY" : "ver-si-fi-KAY-shun". Le "e" initial est réduit. Le "i" est bref. Le suffixe "-ation" se réduit en "shun". Ne dites pas "ver-see-fee-kah-SYOHN" à la française.',
    },
    {
      word: 'Elision',
      phonetic: '/ɪˈlɪʒən/',
  ...
  vocab: [
    {
      english: 'Synesthesia',
      french: 'Synesthésie',
      phonetic: '/ˌsɪnɪsˈθiːʒə/',
      example: 'The synesthesia in Keats\'s "tasting of Flora and the country green" merges gustatory and visual registers, dissolving the boundary between senses.',
      exampleTranslation: 'La synesthésie chez Keats dans "tasting of Flora and the country green" fusionne les registres gustatif et visuel, dissolvant la frontière entre les sens.',
    },
    {
      english: 'Euphony',
      french: 'Euphonie',
      phonetic: '/ˈjuːfəni/',
      example: 'The euphony of liquid consonants and open vowels in "slow, low, moan" creates a sombre acoustic field that envelopes the entire stanza in melancholy.',
      exampleTranslation: 'L\'euphonie des consonnes liquides et des voyelles ouvertes dans "slow, low, moan" crée un champ acoustique sombre qui enveloppe la strophe entière de mélancolie.',
    },
    {
      english: 'Resonance',
      french: 'Résonance',
      phonetic: '/ˈrɛzənəns/',
      example: 'The resonance of the hard "k" sounds throughout Hughes\'s "Thrushes" — "keen, quick, strike" — mimics the sudden predatory precision of the bird.',
      exampleTranslation: 'La résonance des sons durs "k" dans "Thrushes" de Hughes — "keen, quick, strike" — imite la précision prédatrice soudaine de l\'oiseau.',
    },
    {
    ...
    },
    {
      ...
      french: 'Dissonance',
      phonetic: '/ˈdɪsənəns/',
      example: 'The dissonance of Spenser\'s "raging rout" — the guttural "r" and plosive "g" — creates an acoustic violence that mirrors the scene of martial chaos.',
      exampleTranslation: 'La dissonance du "raging rout" de Spenser — le "r" guttural et le "g" occlusif — crée une violence acoustique qui reflète la scène de chaos martial.',
    },
  ],
  grammar: {
  ...
  pronunciation: [
    {
      ...
      phonetic: '/ˌsɪnɪsˈθiːʒə/',
      meaning: 'Synesthésie',
      tip: 'Accent sur "THEE" : "sin-is-THEE-zhuh". Le "eu" central = "ee" long. Le "si" initial = "si" bref. Le suffixe "-ia" = "zhuh". Ne dites pas "sin-es-TAY-zha".',
    },
    {
      word: 'Euphony',
      phonetic: '/ˈjuːfəni/',
      meaning: 'Euphonie',
      tip: 'Accent sur "YOU" : "YOU-feh-ni". Le "eu" initial = "you" comme dans "europe". Le "ph" = "f". Le "y" final = "i" bref. Ne dites pas "eu-FO-ni" à la française.',
    },
    {
      word: 'Dissonance',
      phonetic: '/ˈdɪsənəns/',
      meaning: 'Dissonance',
      tip: 'Accent sur "DIS" : "DIS-eh-nans". Le "i" est bref comme dans "bit". Le milieu se réduit rapidement. Le "-ance" final est doux. Ne dites pas "di-zo-NANS".',
    },
    {
      word: 'Phonaestheme',
      phonetic: '/ˈfoʊnɪsˌθiːm/',
